...
const { blendModes } = require(path.join(basePath, "/src/blendMode.js"));
const { traitTypes } = require(path.join(basePath, "/src/traits.js"));
...
const startCreating = async (storedDNA) => {
  console.log("Beginning creation process...");
  if (storedDNA) {
